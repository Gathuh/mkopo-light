...
public record FeesRequest(
        @NotNull(message = "Fee type cannot be null") FeeType feeType,
        @NotNull(message = "Calculation type cannot be null") CalculationType calculationType,
        BigDecimal amount,
        BigDecimal rate,
        @NotNull(message = "Fee timing cannot be null") FeeTiming timing,
        Integer triggerDays
) {
}
